module github.com/niconical/ogx/example/rel-belongs-to
...
require (
	...
	github.com/niconical/ogx v1.1.8
	github.com/niconical/ogx/dialect/ogdialect v0.0.0-00010101000000-000000000000
